...
public class HiddenOrePlaceholderAbsenceTest {
  private static final String[] LOADS_WITHOUT_PLACEHOLDER_API = {
      "art.arcane.hiddenore.service.HiddenOrePlaceholderService",
      "art.arcane.volmlib.util.bukkit.papi.PlaceholderRegistration"
  };

  private static final String[] REQUIRES_PLACEHOLDER_API = {
      "art.arcane.hiddenore.service.HiddenOrePlaceholderInstaller",
      "art.arcane.hiddenore.service.HiddenOrePlaceholderExpansion"
  };
